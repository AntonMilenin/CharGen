...
public class SkillBase {
    ...
    public static final SkillBase ATARAX_BASE = new SkillBase(
       combatSkill("COMBAT_GUARD", "стражник", "дубина", "копьё", "доспех", 2),
            ...
            commonSkill("BOW_CRAFTING", "лучное дело", 4, Attribute.DEXTERITY),
            ...
            commonSkill("JEWELRY_CRAFTING", "ювелир", 7, Attribute.PERCEPTION),
            ...
            difficultSkill("ALCHEMY", "алхимия", 8, Attribute.INTELLECT, Magic.ALCHEMY),
